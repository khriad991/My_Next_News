                        ...
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <div className="mt-12 lg:mt-0" style={{ zIndex: 10 }}>
                                <h1 className="mt-0 mb-12 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl text-[hsl(218,81%,95%)]">
                                    ...
                                    <span className="text-[hsl(218,81%,75%)]">for your More News</span>
                                </h1>
                            ...
                            <div className="relative mb-12 lg:mb-0">
                                ...
                                <div className="relative bg-[hsla(0,0%,100%,0.9)] backdrop-blur-[25px] backdrop-saturate-[200%] block rounded-lg px-6  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.9)] dark:shadow-black/20 md:px-12 py-20">
                                    <h1 className='text-3xl font-extrabold text-center text-blue-400 mb-6'>Login Here </h1>
                                    <form>
                                        ...
                                        <button
                                            ...
                                            className=" bg-blue-300 hover:bg-blue-200 px-5 py-3 w-full border-1 outline-none border-blue-300
                                              hover:text-gray-900 tracking-[4px] hover:tracking-[2px]  text-black font-bold capitalize rounded-xl  transition-all duration-300 mb-4">
                                            Sign up
                                        </button>
